...
def parse_operator_note(note_id: int, text: str) -> dict[str, Any]:
    ...
    Args:
        note_id: The ID of the operator note (for traceability).
        text: The raw text to parse.
        
    Returns:
        A dictionary perfectly conforming to the DirectiveCompiler
    ...
    try:
        ...
        # 4. Transform back to dictionary matching Compiler discriminated union
        final_dict = validated_model.to_compiler_dict()
        ...
        # but we could set it to 1.0 or None. The compiler handles None.
